...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="d-flex container mt-4 justify-content-center">
            <h5 style="font-size:large;font-family: 'Comfortaa', cursive" class="badge text-center bg-success my-4 ">SUB-CATEGORY</h5>

      <div class="container mt-4 shadow-lg " style="font-size:large;font-family: 'Comfortaa', cursive">
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
     ...
     <div class="container  my-2 " style="font-size:large;font-family: 'Comfortaa', cursive">
             <h5 style="font-size:large;font-family: 'Comfortaa', cursive" class="badge text-dark bg-warning my-4 ">All SUB-CATEGORY'S</h5>
