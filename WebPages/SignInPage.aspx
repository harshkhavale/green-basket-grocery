...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class=" d-flex m-auto justify-content-center" style="font-family: 'Comfortaa', cursive;background-image:url('../Images/signinpng.png');background-repeat:no-repeat;background-size:contain;background-position:left" >

     <div class="container shadow-lg px-4 bg-light col-4 my-4" style="font-family: 'Comfortaa', cursive;margin-left:45vw">
