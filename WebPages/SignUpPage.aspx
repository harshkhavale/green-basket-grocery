...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class=" d-flex m-auto justify-content-center" style="font-family: 'Comfortaa', cursive;background-image:url('../Images/createuserpng.png');background-repeat:no-repeat;background-size:contain;background-position:left" >
         <br /><div id="maincontent" class="container col-3 bg-light shadow-lg mt-4" runat="server" style=" margin-left:50vw">
