...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="container mt-4 d-flex justify-content-center">
           <h5 style="font-size:large;font-family: 'Comfortaa', cursive" class="badge bg-success my-4 ">Categories</h5>
       
    <div class="container mt-4 text-center" style="font-size:large;font-family: 'Comfortaa', cursive">
