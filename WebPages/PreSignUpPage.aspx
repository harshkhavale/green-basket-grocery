...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class=" d-flex m-auto justify-content-center" style="font-family: 'Comfortaa', cursive;background-image:url('../Images/signuppng.png');background-repeat:no-repeat;background-size:contain;background-position:left"  >
          <div class="my-4 h-75  mb-4" style="margin-left:25vw">
        ...
        <div class="card-body">
          <h5 class="card-title text-primary ">GreenBasket !</h5>
