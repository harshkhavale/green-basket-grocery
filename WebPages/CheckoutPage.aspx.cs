...
public partial class WebPages_CheckoutPage : System.Web.UI.Page
{
    ...
    private void SellProduct()
    {
        ...
        else
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO ProductDeliveryTbl VALUES('" + PID + "',GETDATE(),'" + UserName + "','" + CustomerAddress + "','" + CustomerPincode + "','" + CustomerMono + "','" + CustomerName + "','Online','"+null+"')", con);
                cmd.ExecuteNonQuery();
                SqlCommand cmd1 = new SqlCommand("delete from UserCartTbl where ProductId = '" + PID + "'", con);
                cmd1.ExecuteNonQuery();
    ...
    private void SendMail(String Email, String UserName, String EmailBody)
    {
        ...
        using (SmtpClient client = new SmtpClient())
        {
            ...
            client.Credentials = new NetworkCredential("variables.pvt.lmt@gmail.com", "pryresxpewmpugwi");
