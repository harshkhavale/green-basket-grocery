...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="container my-4" style="font-family: 'Comfortaa', cursive;">
                          <h5 style="font-size:large;font-family: 'Comfortaa', cursive;" class="badge bg-success my-4 ">PRODUCT SUMMARY</h5>
          ...
          <img class="bd-placeholder-img" style="width:20vw" src="../Images/ProductImages/<%#Eval("ProductId") %>/<%# Eval("ImageName")%><%# Eval("ImageExtention") %>" alt="<%#Eval("ImageName") %>"/>          
...
<div class="col-4 border rounded position-absolute end-0 top-25 flex-md-row mb-4 shadow-sm h-md-250 ">
